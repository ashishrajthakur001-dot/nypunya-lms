...
public class QuizController {
 ...
 public Quiz create(@RequestBody Quiz quiz,Principal p){quiz.setId(null);quiz.setTrainerId(user(p));quiz.setStatus(QuizStatus.DRAFT);return quizzes.save(quiz);}
